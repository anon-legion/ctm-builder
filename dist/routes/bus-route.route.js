...
// prettier-ignore
router.route('/')
    .post((0, base_validation_chain_1.default)('name').isString().isLength({ min: 3, max: 50 }).escape(), (0, express_validator_1.body)('isActive').isBoolean({ strict: true }), express_validator_handler_1.default, bus_route_controller_1.postBusRoute)
